...
public class Main {
    ...
    public static void exercise1() {
        ...
        switch (fastFoodOrder) {
            ...
            case "fries":
                ...
                break;
            default:
                System.out.println("Not on Menù");// Your cases here!
        }
    ...
    public static void exercise3Bonus() {
        ...
        switch (inputNumber) {
            ...
            default->System.out.println("Invalid entry");// Your switch statement here
        }
    }
}
